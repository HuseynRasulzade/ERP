...
export const SEED_APPROVAL_ROLES: { code: string; name: string; permissions: string[] }[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      PermissionCodes.PURCHASE_PRICE_VIEW,
      PermissionCodes.PAYMENT_REQUEST_VIEW,
      PermissionCodes.PAYMENT_REQUEST_CREATE,
      PermissionCodes.PAYMENT_REQUEST_CANCEL,
      PermissionCodes.PAYMENT_ORDER_VIEW,
      PermissionCodes.PAYMENT_ORDER_CREATE,
      PermissionCodes.PAYMENT_ORDER_EDIT,
      PermissionCodes.PAYMENT_ORDER_APPROVE,
  ...
  },
  {
    ...
    permissions: [
      ...
      PermissionCodes.FIXED_ASSET_VIEW,
      PermissionCodes.FIXED_ASSET_VIEW_COST,
      PermissionCodes.FIXED_ASSET_CREATE,
      PermissionCodes.FIXED_ASSET_ACCEPT,
      PermissionCodes.FIXED_ASSET_COMMISSION,
      PermissionCodes.FIXED_ASSET_TRANSFER,
      PermissionCodes.FIXED_ASSET_MODERNIZE,
      PermissionCodes.FIXED_ASSET_CHANGE_USEFUL_LIFE,
      PermissionCodes.FIXED_ASSET_DEPRECIATION_CALCULATE,
      PermissionCodes.FIXED_ASSET_DEPRECIATION_POST,
      PermissionCodes.FIXED_ASSET_IMPAIR,
      PermissionCodes.FIXED_ASSET_REVALUE,
      PermissionCodes.FIXED_ASSET_INVENTORY,
      PermissionCodes.FIXED_ASSET_DISPOSE,
      PermissionCodes.FIXED_ASSET_WRITE_OFF,
      PermissionCodes.FIXED_ASSET_MANUAL_ADJUSTMENT,
      PermissionCodes.FIXED_ASSET_VIEW_ACCOUNTING,
      PermissionCodes.FIXED_ASSET_PERIOD_OVERRIDE,
      PermissionCodes.FIXED_ASSET_SETTINGS_MANAGE,
    ],
  },
  {
    code: 'WAREHOUSE_USER',
  ...
  {
    // Phase 17 — HR specialist: full HR operations incl. personal data,
    // but no compensation/bank/medical and no approval of own documents.
    code: 'HR_SPECIALIST',
    name: 'HR Specialist',
    permissions: [
      PermissionCodes.ORGANIZATION_VIEW,
      PermissionCodes.HR_PERSON_VIEW,
      PermissionCodes.HR_PERSON_CREATE,
      PermissionCodes.HR_PERSON_EDIT,
      PermissionCodes.HR_EMPLOYEE_VIEW,
      PermissionCodes.HR_EMPLOYEE_CREATE,
      PermissionCodes.HR_EMPLOYMENT_CREATE,
      PermissionCodes.HR_HIRE_CREATE,
      PermissionCodes.HR_HIRE_POST,
      PermissionCodes.HR_TRANSFER_CREATE,
      PermissionCodes.HR_TRANSFER_POST,
      PermissionCodes.HR_TERMINATE_CREATE,
      PermissionCodes.HR_TERMINATE_POST,
      PermissionCodes.HR_CONTRACT_VIEW,
      PermissionCodes.HR_CONTRACT_EDIT,
      PermissionCodes.HR_STAFFING_VIEW,
      PermissionCodes.HR_LEAVE_VIEW,
      PermissionCodes.HR_LEAVE_MANAGE,
      PermissionCodes.HR_ABSENCE_VIEW,
      PermissionCodes.HR_ABSENCE_MANAGE,
      PermissionCodes.HR_VIEW_PERSONAL_DATA,
      PermissionCodes.HR_VIEW_HISTORY,
      PermissionCodes.HR_REPORTS_VIEW,
    ],
  },
  {
    // Phase 17 — HR manager: approver + sensitive domains (spec 61/81).
    code: 'HR_MANAGER',
    name: 'HR Manager',
    permissions: [
      PermissionCodes.ORGANIZATION_VIEW,
      ...
      PermissionCodes.HR_CONTRACT_EDIT,
      PermissionCodes.HR_STAFFING_VIEW,
      PermissionCodes.HR_STAFFING_EDIT,
      PermissionCodes.HR_LEAVE_VIEW,
      PermissionCodes.HR_LEAVE_MANAGE,
      PermissionCodes.HR_ABSENCE_VIEW,
      PermissionCodes.HR_VIEW_PERSONAL_DATA,
      PermissionCodes.HR_VIEW_SENSITIVE_DATA,
      PermissionCodes.HR_VIEW_COMPENSATION,
      PermissionCodes.HR_VIEW_BANK_INFO,
      PermissionCodes.HR_VIEW_MEDICAL,
      PermissionCodes.HR_VIEW_HISTORY,
      PermissionCodes.HR_OVERRIDE_STAFFING_LIMIT,
      PermissionCodes.HR_DOCUMENT_APPROVE,
      PermissionCodes.HR_DOCUMENT_REVERSE,
      PermissionCodes.HR_REPORTS_VIEW,
      PermissionCodes.HR_CONFIG_MANAGE,
    ],
  },
];
