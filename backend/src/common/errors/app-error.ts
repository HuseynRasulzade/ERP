...
export const ErrorCode = {
  ...
  // Fixed Assets (docx spec Phase 16, section 145)
  FIXED_ASSET_INVALID_STATE: 'FIXED_ASSET_INVALID_STATE',
  FIXED_ASSET_COST_INCOMPLETE: 'FIXED_ASSET_COST_INCOMPLETE',
  FIXED_ASSET_CANDIDATE_ALREADY_PROCESSED: 'FIXED_ASSET_CANDIDATE_ALREADY_PROCESSED',
  FIXED_ASSET_CIP_BALANCE_EXCEEDED: 'FIXED_ASSET_CIP_BALANCE_EXCEEDED',
  FIXED_ASSET_CIP_RESIDUAL: 'FIXED_ASSET_CIP_RESIDUAL',
  FIXED_ASSET_POLICY_VIOLATION: 'FIXED_ASSET_POLICY_VIOLATION',
  FIXED_ASSET_REVERSAL_BLOCKED: 'FIXED_ASSET_REVERSAL_BLOCKED',
  FIXED_ASSET_DEPRECIATION_DUPLICATE: 'FIXED_ASSET_DEPRECIATION_DUPLICATE',
  FIXED_ASSET_DEPRECIATION_STALE: 'FIXED_ASSET_DEPRECIATION_STALE',
  FIXED_ASSET_DEPRECIATION_NOT_FINALIZED: 'FIXED_ASSET_DEPRECIATION_NOT_FINALIZED',
  FIXED_ASSET_NEGATIVE_NBV: 'FIXED_ASSET_NEGATIVE_NBV',
} as const;
