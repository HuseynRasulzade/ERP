...
export const PermissionCodes = {
  ...
  // Phase 17 — HR Core / Kadr uçotu (spec section 80, 61)
  ...
  HR_TERMINATE_CREATE: 'hr.termination.create',
  HR_TERMINATE_POST: 'hr.termination.post',
  ...
  HR_VIEW_PERSONAL_DATA: 'hr.personal_data.view',
  HR_VIEW_SENSITIVE_DATA: 'hr.sensitive_data.view',
  HR_VIEW_COMPENSATION: 'hr.compensation.view',
  HR_VIEW_BANK_INFO: 'hr.bank_info.view',
  HR_VIEW_MEDICAL: 'hr.medical.view',
  HR_VIEW_HISTORY: 'hr.history.view',
  HR_OVERRIDE_STAFFING_LIMIT: 'hr.staffing.override_limit',
  HR_DOCUMENT_APPROVE: 'hr.document.approve',
  HR_DOCUMENT_REVERSE: 'hr.document.reverse',
  HR_REPORTS_VIEW: 'hr.reports.view',
  HR_CONFIG_MANAGE: 'hr.config.manage',
  // Fixed Assets (docx spec Phase 16, section 126)
  ...
  FIXED_ASSET_SETTINGS_MANAGE: 'fixed_asset.settings.manage',
} as const;
...
export const ALL_PERMISSION_CODES: { code: string; module: string; description: string }[] = [
  ...
  { code: PermissionCodes.HR_PERSON_VIEW, module: 'hr', description: 'View physical persons (non-sensitive fields)' },
  { code: PermissionCodes.HR_PERSON_CREATE, module: 'hr', description: 'Create physical persons' },
  { code: PermissionCodes.HR_PERSON_EDIT, module: 'hr', description: 'Edit physical persons' },
  { code: PermissionCodes.HR_EMPLOYEE_VIEW, module: 'hr', description: 'View employees, employments and their effective-dated state' },
  { code: PermissionCodes.HR_EMPLOYEE_CREATE, module: 'hr', description: 'Create employees (HR identity)' },
  { code: PermissionCodes.HR_EMPLOYMENT_CREATE, module: 'hr', description: 'Register employment events (schedule change, suspension, attributes)' },
  { code: PermissionCodes.HR_HIRE_CREATE, module: 'hr', description: 'Create hire/rehire documents' },
  { code: PermissionCodes.HR_HIRE_POST, module: 'hr', description: 'Post hire/rehire documents' },
  { code: PermissionCodes.HR_TRANSFER_CREATE, module: 'hr', description: 'Create transfer documents' },
  { code: PermissionCodes.HR_TRANSFER_POST, module: 'hr', description: 'Post transfer documents' },
  { code: PermissionCodes.HR_TERMINATE_CREATE, module: 'hr', description: 'Create termination documents' },
  { code: PermissionCodes.HR_TERMINATE_POST, module: 'hr', description: 'Post termination documents' },
  ...
  { code: PermissionCodes.HR_STAFFING_VIEW, module: 'hr', description: 'View positions and staffing tables' },
  { code: PermissionCodes.HR_STAFFING_EDIT, module: 'hr', description: 'Manage positions, schedules and staffing tables' },
  { code: PermissionCodes.HR_LEAVE_VIEW, module: 'hr', description: 'View leave records' },
  { code: PermissionCodes.HR_LEAVE_MANAGE, module: 'hr', description: 'Register/approve leave records and business trips' },
  { code: PermissionCodes.HR_ABSENCE_VIEW, module: 'hr', description: 'View absence records' },
  { code: PermissionCodes.HR_ABSENCE_MANAGE, module: 'hr', description: 'Register absence records' },
  { code: PermissionCodes.HR_VIEW_PERSONAL_DATA, module: 'hr', description: 'View personal data (IDs, birth date, private address/contacts)' },
  { code: PermissionCodes.HR_VIEW_SENSITIVE_DATA, module: 'hr', description: 'View sensitive HR attributes (tax/social/disability categories)' },
  { code: PermissionCodes.HR_VIEW_COMPENSATION, module: 'hr', description: 'View compensation references on contracts' },
  { code: PermissionCodes.HR_VIEW_BANK_INFO, module: 'hr', description: 'View/manage employee payroll bank accounts' },
  { code: PermissionCodes.HR_VIEW_MEDICAL, module: 'hr', description: 'View medical/sensitive personnel documents' },
  { code: PermissionCodes.HR_VIEW_HISTORY, module: 'hr', description: 'View effective-dated HR history, timeline and events' },
  { code: PermissionCodes.HR_OVERRIDE_STAFFING_LIMIT, module: 'hr', description: 'Override staffing capacity limits on hire/transfer' },
  { code: PermissionCodes.HR_DOCUMENT_APPROVE, module: 'hr', description: 'Approve HR documents (hire/transfer/termination)' },
  { code: PermissionCodes.HR_DOCUMENT_REVERSE, module: 'hr', description: 'Reverse posted HR documents (e.g. termination cancellation)' },
  { code: PermissionCodes.HR_REPORTS_VIEW, module: 'hr', description: 'View HR reports, org chart, headcount and HR health' },
  { code: PermissionCodes.HR_CONFIG_MANAGE, module: 'hr', description: 'Manage HR policies, catalogs and HR periods' },
  { code: PermissionCodes.FIXED_ASSET_VIEW, module: 'fixed_assets', description: 'View fixed assets, CIP projects and acquisition candidates' },
  { code: PermissionCodes.FIXED_ASSET_VIEW_COST, module: 'fixed_assets', description: 'View fixed asset cost / depreciation / NBV amounts' },
  { code: PermissionCodes.FIXED_ASSET_CREATE, module: 'fixed_assets', description: 'Create fixed asset cards, CIP projects and manual candidates; classify candidates' },
  { code: PermissionCodes.FIXED_ASSET_ACCEPT, module: 'fixed_assets', description: 'Accept fixed assets into the register (initial recognition)' },
  { code: PermissionCodes.FIXED_ASSET_COMMISSION, module: 'fixed_assets', description: 'Commission (put into use) fixed assets' },
  { code: PermissionCodes.FIXED_ASSET_TRANSFER, module: 'fixed_assets', description: 'Transfer fixed assets between departments/locations/responsible persons' },
  { code: PermissionCodes.FIXED_ASSET_MODERNIZE, module: 'fixed_assets', description: 'Record modernization and repairs of fixed assets' },
  { code: PermissionCodes.FIXED_ASSET_CHANGE_USEFUL_LIFE, module: 'fixed_assets', description: 'Change useful life / residual value / depreciation method' },
  { code: PermissionCodes.FIXED_ASSET_DEPRECIATION_CALCULATE, module: 'fixed_assets', description: 'Preview and calculate fixed asset depreciation' },
  { code: PermissionCodes.FIXED_ASSET_DEPRECIATION_POST, module: 'fixed_assets', description: 'Post, reverse and finalize fixed asset depreciation runs' },
  { code: PermissionCodes.FIXED_ASSET_IMPAIR, module: 'fixed_assets', description: 'Record fixed asset impairment and impairment reversal' },
  { code: PermissionCodes.FIXED_ASSET_REVALUE, module: 'fixed_assets', description: 'Record fixed asset revaluation' },
  { code: PermissionCodes.FIXED_ASSET_INVENTORY, module: 'fixed_assets', description: 'Run physical fixed asset inventory counts' },
  { code: PermissionCodes.FIXED_ASSET_DISPOSE, module: 'fixed_assets', description: 'Dispose / sell fixed assets' },
  { code: PermissionCodes.FIXED_ASSET_WRITE_OFF, module: 'fixed_assets', description: 'Write off, scrap or record loss of fixed assets' },
  { code: PermissionCodes.FIXED_ASSET_MANUAL_ADJUSTMENT, module: 'fixed_assets', description: 'Opening balances, status changes and other manual fixed asset adjustments' },
  { code: PermissionCodes.FIXED_ASSET_VIEW_ACCOUNTING, module: 'fixed_assets', description: 'View fixed asset reports, reconciliation and health' },
  { code: PermissionCodes.FIXED_ASSET_PERIOD_OVERRIDE, module: 'fixed_assets', description: 'Reverse fixed asset operations / reopen depreciation periods' },
  { code: PermissionCodes.FIXED_ASSET_SETTINGS_MANAGE, module: 'fixed_assets', description: 'Manage fixed asset categories, policies and locations' },
];
