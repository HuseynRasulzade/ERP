...
## Sales Order (increment 4, `src/sales-documents/`)
...
type beyond Purchase Requirement/Order/Goods Receipt/Purchase Invoice/Payment
Order/Sales Order, and auto-stock-reservation on Sales Order confirmation
(tried and reverted — see above). See
