...
const az: Translations = {
  ...
  nav: {
    ...
    paymentOrders: 'Ödəniş Tapşırıqları',
  ...
  treasury: {
    sourceInvoice: 'Mənbə faktura',
    sourceRequest: 'Mənbə ödəniş tələbi',
    amountDefaultHint: 'susmaya görə fakturanın qalan məbləği',
    noPaymentRequests: 'Hələ ödəniş tələbi yoxdur.',
    noPaymentOrders: 'Hələ ödəniş tapşırığı yoxdur.',
    paymentRequestCancelled: 'Ödəniş tələbi ləğv edildi',
    paymentOrderCreated: 'Ödəniş tapşırığı yaradıldı',
    paymentOrderSingular: 'ödəniş tapşırığı',
    createPaymentOrder: 'Ödəniş tapşırığı yarat',
    bankAccount: 'Bank hesabı',
    bankPaymentStatus: 'Bank ödəniş statusu',
    bankReference: 'Bank istinadı',
    reconciliation: 'Bank uzlaşdırması',
    reconciled: 'Uzlaşdırıldı',
    reconcile: 'Uzlaşdır',
    bankStatementAmount: 'Bank çıxarışı məbləği',
    reconciliationDifference: 'Fərq',
  },
