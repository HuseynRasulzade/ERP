const en = {
  ...
  treasury: {
    ...
    sourceRequest: 'Source payment request',
    amountDefaultHint: 'defaults to invoice remaining balance',
    noPaymentRequests: 'No payment requests yet.',
    noPaymentOrders: 'No payment orders yet.',
    paymentRequestCancelled: 'Payment request cancelled',
    paymentOrderCreated: 'Payment order created',
    paymentOrderSingular: 'payment order',
    ...
    reconcile: 'Reconcile',
    bankStatementAmount: 'Bank statement amount',
